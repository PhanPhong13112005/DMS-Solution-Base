...
import { ChartSpline, Users, Shield, LogOut, ArrowUpRight, ArrowDownRight, Settings, PlusCircle, Trash2, Calendar, Newspaper, Activity, Landmark, BellRing, Info, AlertTriangle, CheckCircle, Receipt, Search, Eye, Copy, Inbox, ClipboardList, Download, ArrowUp, ArrowDown, Wrench, UserPlus, Calculator, FileText, Home, CircleDollarSign } from 'lucide-vue-next';
...
const emit = defineEmits<{
  ...
  (e: 'deleteInvoice', invoiceId: string): void;
  (e: 'addInvoice', invoice: Invoice): void;
  (e: 'payInvoice', invoiceId: string): void;
  (e: 'deletePayment', invoiceId: string): void;
}>();
